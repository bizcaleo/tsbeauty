...
<head>
    ...
    <title>T.S Beauty Home Page </title>
    <!-- Bootstrap -->
...
<body>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                    <h1 class="hero-title">T.S Beauty Parlour Management</h1>
    ...
    <div class="space-medium bg-default">
        <div class="container">
            <div class="row">
                <div class="col-lg-5 col-md-5 col-sm-12 col-xs-12"><img src="images/salonmnw.jpg" alt="" class="img-responsive"></div>
