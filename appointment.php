...
<head>
    ...
    <title>T.S Beauty Appointments </title>
    <!-- Bootstrap -->
            ...
            <div class="row">
                ...
                <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            ...
                            <p> Book your appointment to save the service rush.</p>
                            <form method="post">
                                <div class="row">
                                    <div class="col-md-6">
              ...
              ?>
                               ...
                               <?php } ?> 
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        <div class="form-group">
                                            <label class="control-label" for="textarea">Appointment Time (GMT+3)</label>
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                        <div class="footer-widget">
                            ...
                            <ul class="listnone contact">
                                <li><i class="fa fa-map-marker"></i> Nairobi </li>
                                <li><i class="fa fa-phone"></i> +254 721 426 058</li>

                                <li><i class="fa fa-envelope-o"></i> consult@tuza.solutions</li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-5 col-md-5 col-sm-12 col-xs-12">
                        <div class="footer-widget widget-newsletter">
                            ...
                            <p>Enter your email address to receive updates and other useful information right to your inbox.</p>
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="copyright-content">
                                <p> T.S. Websites | all rights reserved</p>
                            </div>
                        </div>
                    </div>
                </div>
